...
SET THINGVERSE_OPTS=-Dakka.cluster.roles.0=read-model -Dakka.cluster.roles.1=read-model -Dakka.cluster.node.port=2553 -Dthingverse.grpc.server.port=8082 -Dakka.cluster.sharding.remember-entities=off
