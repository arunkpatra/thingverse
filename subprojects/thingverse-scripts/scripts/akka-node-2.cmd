...
set APP_NAME=thingverse-backend
...
SET THINGVERSE_OPTS=-Dakka.cluster.roles.0=write-model -Dakka.cluster.roles.1=write-model -Dakka.cluster.node.port=2552 -Dthingverse.grpc.server.port=8081 -Dakka.cluster.sharding.remember-entities=off
