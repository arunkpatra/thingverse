...
==== Thingverse Development Cluster Deployment

===== Introduction
This deployment is suitable only for testing the clustering capabilities of Thingverse.

[CAUTION]
====
Do not use this deployment for production.
====
...
===== Script File(s)
We use the following scripts in the deployment.
...
`thingverse-dev-cluster-consul.yaml`
[source, yaml]
----
include::{sourcedir}/thingverse/thingverse-dev-cluster/thingverse-dev-cluster-consul.yaml[]
----

`thingverse-dev-cluster-cassandra-plus-web-ui.yaml`
[source, yaml]
----
include::{sourcedir}/thingverse/thingverse-dev-cluster/thingverse-dev-cluster-cassandra-plus-web-ui.yaml[]
----

`thingverse-dev-cluster-backend-read.yaml`
[source, yaml]
----
include::{sourcedir}/thingverse/thingverse-dev-cluster/thingverse-dev-cluster-backend-read.yaml[]
----

`thingverse-dev-cluster-backend-write.yaml`
[source, yaml]
----
include::{sourcedir}/thingverse/thingverse-dev-cluster/thingverse-dev-cluster-backend-write.yaml[]
----

===== Components Included

|===
|Component |Instances | Host Port(s) |Container Port(s) |Dependencies |User testing endpoint
