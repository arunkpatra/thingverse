...
class DecentLoadSimulation extends Simulation {
...
//    .shareConnections
  ...
  val closedModelTrafficProfile = Seq(
    ...
    constantConcurrentUsers(32) during (4 seconds), // Drive steady at second gear
    rampConcurrentUsers(32) to (64) during (4 seconds), // Switch to third gear
    constantConcurrentUsers(64) during (30 minutes) // Welcome to Akka - You are cruising at 36,000 feet.
  )
