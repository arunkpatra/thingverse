...
/**
 * See https://stackoverflow.com/questions/5762491/how-to-print-color-in-console-using-system-out-println to get
 * inspired.
 */
public interface ConsoleColors {
    ...
    static String format(String fmt, String data) {
        if (System.console() != null && System.getenv().get("TERM") != null) {
            return fmt + data + RESET;
        } else {
            return data;
        }
    }
